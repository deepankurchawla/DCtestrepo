...
<CustomApplication xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <description>Console App for Call Center/Reservations team</description>
    ...
    <footerColor>#e60000</footerColor>
    <headerColor>#ebebe0</headerColor>
    ...
    <logo>SharedDocuments/Spicejet_App_Logo.png</logo>
    <primaryTabColor>#e60000</primaryTabColor>
    <pushNotifications>
        <pushNotification>
            <fieldNames>Status__c</fieldNames>
            <objectName>BIR_Tracer__c</objectName>
        </pushNotification>
        <pushNotification>
